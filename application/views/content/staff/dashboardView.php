	...
	<div class="row">
		<div class="col-lg-3 col-xs-6">
			<div class="small-box bg-aqua">
				...
				<a href="<?= base_url('staff/transaksi/list/keluar') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
		<div class="col-lg-3 col-xs-6">
		...
		<div class="col-lg-3 col-xs-6">
			<div class="small-box bg-green">
				...
				<a href="<?= base_url('staff/transaksi/list/masuk') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
			</div>
		</div>
		<div class="col-lg-3 col-xs-6">
